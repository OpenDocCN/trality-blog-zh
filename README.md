...
> 原文：[Trality Blog](https://www.trality.com/blog)
> 
...
* [在线阅读](https://trality.apachecn.org)
...
*   在我们的 [apachecn/trality-blog-zh](https://github.com/apachecn/trality-blog-zh) github 上提 issue.
...
```
docker pull apachecn0/trality-blog-zh
docker run -tid -p <port>:80 apachecn0/trality-blog-zh
...
```
pip install trality-blog-zh
trality-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
